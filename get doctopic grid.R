...
get.doctopic.grid <- function(dataset_name = "noexcludes2001_2015",
                              ...
                              remake_grid = F,   # usually we won't want to re-export the grid, even if remake_figs=T
                              bad.topics = NULL) # don't assume you want to leave things out
{
