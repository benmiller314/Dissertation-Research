                                 ...
                                 schools = NULL)          # a list of new schools to filter for matching/adding
{
    ...
    if (tolower(substr(do_manual, 1, 1)) == "y" & file.exists(manual_file)) {
    ...
    do_alumni <- readline("Update realconsorts from this file? (y/n)  ")
    if (tolower(substr(do_alumni, 1, 1)) == 'y' & file.exists(alumni_file)) {
