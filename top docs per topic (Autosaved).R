...
ntopics <- "150"
cutoff <- 30		# I want to set this high, b/c a lot of "top" topics are just academic discourse.							# one way around this would be to throw out non-nouns, but...
...
# to get a sense of what's "real" and what's "interesting"
	...
	get.topics4doc <- function(pubnum, doc_tops=doc_topics.dt, topic_keys=topic_keys.dt) {
		...
		list("title" = noexcludes.dt[pubnum, Title],
