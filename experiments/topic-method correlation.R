...
methods_for_topic <- function(	dataset_name = "consorts",
	...
	grid <- data.table(get.doctopic.grid(dataset_name=dataset_name, ntopics=ntopics,
...
if(autorun) {
	...
	label1 <- paste("32:", get_topic_labels(dataset_name=dataset_name, ntopics=ntopics)[32, Label])
	...
	for (i in 1:ncol(pairs)) {
		...
		lab1 <- paste0(topic_1, ": ", get_topic_labels(dataset_name=dataset_name, ntopics=ntopics, iter_index=iter_index)[topic_1, Label])
		lab2 <- paste0(topic_2, ": ", get_topic_labels(dataset_name=dataset_name, ntopics=ntopics, iter_index=iter_index)[topic_2, Label])
...
methods_in_cotopics <- function(dataset_name="consorts",
										  ntopics=55,
										  iter_index="",
	...
	test <- get.cotopics(dataset_name, ntopics, iter_index=iter_index, subset_name=subset_name, level)
